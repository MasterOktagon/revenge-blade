...
main: app.o main.o sprite.o helper.o draw.o
	g++ build/main.o build/app.o build/sprite.o build/draw.o build/helper.o build/userinput.o -o revenge-Blade $(link)
...
sprite.o: src/userinput.cpp src/userinput.h
